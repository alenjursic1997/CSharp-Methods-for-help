...
namespace Helpers.EncryptionDecryption
{
	public static class AES
	{

		// Decryption Password
		public static string privateKey = "6t18gw20il";
		...
		private static byte[] Encrypt(byte[] clearData, byte[] Key, byte[] IV)
		{
			...
			// This is done to make encryption more secure. There is also a mode called ECB which does not need an IV,
			...
			// there is no more data coming in,       // and it is now a good time to apply the padding and
